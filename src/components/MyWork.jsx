...
const MyWork = () => {
    ...
    return (
        <Card style={{ width: '80%', margin: '0 auto', padding: '20px' }}>
            <Typography variant='h4' style={{textAlign:'center',fontFamily:'Protest Guerrilla',color:'#1E2A5E'}}>My Work & Experiences</Typography>
            ...
            <Box sx={{ textAlign: 'center', p: 2 }}>
                <Button onClick={()=>setShowing({name:'MyWork',data:allwork})} 
                    ...
                    {mr:2,color:'#1E2A5E',fontFamily:'Protest Guerrilla'}} 
                ...
                <Button onClick={()=>setShowing({name:'MyExp',data:myExp})} 
                    ...
                    {color:'#1E2A5E',fontFamily:'Protest Guerrilla'}} variant='outlined'>My Experience</Button>
            </Box>
